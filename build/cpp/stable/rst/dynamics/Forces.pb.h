...
public:
   ...
   */
  static const Forces& default_instance();
...
// Accessors for rst::dynamics::Forces

 bool rst::dynamics::Forces::has_x() const{
  return true;
}

 const float&rst::dynamics::Forces::x() const{
  return this->_x;
}

 void rst::dynamics::Forces::set_x(const float&newValue){
  this->_x=newValue;
}



 bool rst::dynamics::Forces::has_y() const{
  return true;
}

 const float&rst::dynamics::Forces::y() const{
  return this->_y;
}

 void rst::dynamics::Forces::set_y(const float&newValue){
  this->_y=newValue;
}



 bool rst::dynamics::Forces::has_z() const{
  return true;
}

 const float&rst::dynamics::Forces::z() const{
  return this->_z;
}

 void rst::dynamics::Forces::set_z(const float&newValue){
  this->_z=newValue;
}
