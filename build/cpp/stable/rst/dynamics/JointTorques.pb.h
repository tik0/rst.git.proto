...
// Accessors for rst::dynamics::JointTorques

 bool rst::dynamics::JointTorques::has_angles() const{
  return true;
}

 int rst::dynamics::JointTorques::angles_size() const{
  return this->_angles.size();
}
 const float& rst::dynamics::JointTorques::angles(unsigned int index) const{
  return this->_angles[index];
}
 const std::vector<float>&rst::dynamics::JointTorques::angles() const{
  return this->_angles;
}



 void rst::dynamics::JointTorques::set_angles(unsigned int index,const float& newValue){
 ...
 void rst::dynamics::JointTorques::add_angles(const float& newValue){
