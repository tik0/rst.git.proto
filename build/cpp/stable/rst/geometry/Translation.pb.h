...
// Accessors for rst::geometry::Translation

 bool rst::geometry::Translation::has_x() const{
  return true;
}

 const double&rst::geometry::Translation::x() const{
  return this->_x;
}

 void rst::geometry::Translation::set_x(const double&newValue){
  this->_x=newValue;
}



 bool rst::geometry::Translation::has_y() const{
  return true;
}

 const double&rst::geometry::Translation::y() const{
  return this->_y;
}

 void rst::geometry::Translation::set_y(const double&newValue){
  this->_y=newValue;
}



 bool rst::geometry::Translation::has_z() const{
  return true;
}

 const double&rst::geometry::Translation::z() const{
  return this->_z;
}

 void rst::geometry::Translation::set_z(const double&newValue){
  this->_z=newValue;
}
