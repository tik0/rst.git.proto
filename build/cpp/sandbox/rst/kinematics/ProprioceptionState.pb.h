...
public:
   ...
   */
  static const ProprioceptionState& default_instance();
...
// Accessors for rst::kinematics::ProprioceptionState

 bool rst::kinematics::ProprioceptionState::has_joints() const{
  return true;
}

 int rst::kinematics::ProprioceptionState::joints_size() const{
  return this->_joints.size();
}
 const rst::kinematics::JointState& rst::kinematics::ProprioceptionState::joints(unsigned int index) const{
  return this->_joints[index];
}
 const std::vector<rst::kinematics::JointState>&rst::kinematics::ProprioceptionState::joints() const{
  return this->_joints;
}



 void rst::kinematics::ProprioceptionState::set_joints(unsigned int index,const rst::kinematics::JointState& newValue){
 ...
 rst::kinematics::JointState* rst::kinematics::ProprioceptionState::add_joints(){
