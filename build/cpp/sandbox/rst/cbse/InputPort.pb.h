...
// Accessors for rst::cbse::InputPort

 bool rst::cbse::InputPort::has_scope() const{
  return true;
}

 const std::string&rst::cbse::InputPort::scope() const{
  return this->_scope;
}

 std::string*rst::cbse::InputPort::mutable_scope(){
  return &this->_scope;
}

 void rst::cbse::InputPort::set_scope(const std::string&newValue){
  this->_scope=newValue;
}



 bool rst::cbse::InputPort::has_buffersize() const{
  return true;
}

 const boost::uint64_t&rst::cbse::InputPort::buffersize() const{
  return this->_buffersize;
}

 void rst::cbse::InputPort::set_buffersize(const boost::uint64_t&newValue){
  this->_buffersize=newValue;
}



 bool rst::cbse::InputPort::has_filling() const{
  return true;
}

 const boost::uint64_t&rst::cbse::InputPort::filling() const{
  return this->_filling;
}

 void rst::cbse::InputPort::set_filling(const boost::uint64_t&newValue){
